...
def create_sc(a, mlp)
    ...
    write(f'structure/{mlp}/{mlp}_sc.poscar',sc, format='vasp')
    return fe_sc
...
def a1(fe,a,mlp):
    ...
    write(f'structure/{mlp}/{mlp}_a1.poscar',fe_a1, format='vasp')
    return fe_a1
...
def a2(fe,a,mlp):
    ...
    write(f'structure/{mlp}/{mlp}_a2.poscar',fe_a2,format='vasp')
    return fe_a2
...
def b1(fe, a, mlp):
    ...
    write(f'structure/{mlp}/{mlp}_b1.poscar',fe_b1,format='vasp')
    return fe_b1
...
def b2(fe, a, mlp):
    ...
    write(f'structure/{mlp}/{mlp}_b2.poscar',fe_b2,format='vasp')
    return fe_b2
...
def b3(fe, a, mlp):
    ...
    write(f'structure/{mlp}/{mlp}_b3.poscar', fe_b3, format='vasp')
    return fe_b3
...
def c1(fe, a, mlp):
    ...
    write(f'structure/{mlp}/{mlp}_c1.poscar',fe_c1, format='vasp')
    return fe_c1
...
def c2(fe, a, mlp):
    ...
    write(f'structure/{mlp}/{mlp}_c2.poscar',fe_c2 format='vasp')
    return fe_c2
...
def d(fe, a, mlp):
    ...
    write(f'structure/{mlp}/{mlp}_d.poscar',fe_d, format='vasp')
    return fe_d
...
def e(fe,a,mlp):
    ...
    write(f'structure/{mlp}/{mlp}_e.poscar',fe_e, format='vasp')
    return fe_e
...
def f(fe, a, mlp):
    ...
    write(f'structure/{mlp}/{mlp}_f.poscar',fe_f,format='vasp')

def i(fe,a,mlp):
    fe_i = fe.copy()
    fe_i.append(Atoms('C', positions=[(a/2,a/2,a)]))
    fe_i.append(Atoms('C', positions=[(0,0,a/2)]))
    write(f'structure/{mlp}/{mlp}_i.poscar',fe_i,format='vasp')
    return fe_i
...
def g(fe,a,mlp):
    ...
    write(f'structure/{mlp}/{mlp}_g.poscar',fe_g,format='vasp')
    return fe_g
...
def h(fe, a, mlp):
    ...
    write(f'structure/{mlp}/{mlp}_h.poscar', fe_h, format='vasp')
...
def j(fe,a,mlp):
    ...
    write(f'structure/{mlp}/{mlp}_j.poscar',fe_j,format='vasp')
    return fe_j
...
def k(fe,a,mlp):
    ...
    write(f'structure/{mlp}/{mlp}_k.poscar',fe_k,format='vasp')
    return fe_k
...
def l(fe,a,mlp):
    ...
    write(f'structure/{mlp}/{mlp}_l.poscar',fe_l,format='vasp')
    return fe_l
...
def m(fe,a,mlp):
    ...
    write(f'structure/{mlp}/{mlp}_m.poscar',fe_m,format='vasp')
    return fe_m


def vacency(name, fe, mlp, inp):
    fe_vac=fe.copy()
    p=inp[name]['p']
    if p==2:
        vac=inp[name]['vac']
        del fe_vac[vac[0]]
        del fe_vac[vac[1]]
        tag='13' if 3 in vac else '01'       
        write(f'structure/{mlp}/{mlp}_vac{tag}.mlp',fe_vac, format='vasp')
        return fe_vac
    elif p==1:
        del fe_vac[p]
        tag=str(p)
        ...
        raise ValueError("p, number/index of vacancy/ies should be a integer/list of integers")

def carbon_interstitial(name, fe, mlp, inp):
    fe_c=fe.copy()
    q=inp[name]['q']
    q_pos=inp[name]['q_pos']
